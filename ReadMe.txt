...
3. Execute program
	- in the terminal, run node server.js (you must be in the file folder path in order for the server to run)
	- open a browser and in the address bar, go to localhost:3000